        ...
        <section className="relative h-screen flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
                    ShrinkVerse turns long URLs into short, customizable links that are easy to
                    share and track. Simplify your sharing experience today. Make every link
                    memorable and efficient. Create, share, and track with ease.
                </p>
